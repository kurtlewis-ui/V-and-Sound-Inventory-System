...
export default function BrandsArchivePage() {
  ...
  const handlePermanentDelete = async () => {
    ...
    try { await api.delete(`/brands/${deletingId}/permanent`); setDeletingId(null); refetch(); } catch (e) { setActionError(getApiErrorMessage(e)); }

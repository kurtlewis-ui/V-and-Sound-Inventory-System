...
export default function BrandsArchivePage() {
  ...
  const handleRestore = async (id: string) => { setActionError(null); try { await restore.mutateAsync(id); showToast('Brand has been restored.', 'green', 'restore'); } catch (e) { setActionError(getApiErrorMessage(e)); } };

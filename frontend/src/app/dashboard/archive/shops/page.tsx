...
export default function ShopsArchivePage() {
  ...
  const handlePermanentDelete = async () => {
    ...
    try { await api.delete(`/branches/${deletingId}/permanent`); setDeletingId(null); refetch(); } catch (e) { setActionError(getApiErrorMessage(e)); }
